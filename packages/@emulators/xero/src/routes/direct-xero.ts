// Direct xero native routes — standalone (extracted from the nango
...
//
//   POST /connect/token                  → OAuth2 token (cc/refresh)
//   GET  /connections                    → tenant list (tenantId)
//   POST /api.xro/2.0/Invoices           → create → emit webhook
//   GET  /api.xro/2.0/Invoices           → list
//   GET  /api.xro/2.0/Invoices/:id       → read one
//
