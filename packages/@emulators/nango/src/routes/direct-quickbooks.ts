// Direct QuickBooks Online emulator routes (mounted under the nango plugin
...
// end-to-end:
//
//   POST /quickbooks-emu/oauth2/v1/tokens/bearer        → OAuth2 token
//   POST /quickbooks-emu/v3/company/:realmId/invoice     → create → webhook
//   GET  /quickbooks-emu/v3/company/:realmId/invoice/:id → read one
//   GET  /quickbooks-emu/v3/company/:realmId/query?query=SELECT * FROM Invoice
//
