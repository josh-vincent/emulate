// Direct Salesforce REST/SOQL emulator routes (mounted under the nango plugin
...
//
//   GET  /salesforce-emu/services/oauth2/authorize           → consent page
//   POST /salesforce-emu/services/oauth2/authorize/callback   → mints code
//   POST /salesforce-emu/services/oauth2/token                → password +
//                                                                authorization_code +
//                                                                refresh_token
...
const instanceUrl = (c: Context): string => `${new URL(c.req.url).origin}/salesforce-emu`;
