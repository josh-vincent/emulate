...
import { shopifyPlugin, seedFromConfig, storeToSeedConfig } from "../index.js";
...
function mk() {
  ...
  const app = new Hono();
  shopifyPlugin.register(app as never, store, new WebhookDispatcher(), base);
  return { app, store };
}
...
describe("shopify standalone native (native-kit, seed-derived)", () => {
