// Direct hubspot native routes — standalone (extracted from the nango
...
//   GET    /crm/v3/objects/:type                 → list (paged)
//   GET    /crm/v3/objects/:type/:id             → read
//   PATCH  /crm/v3/objects/:type/:id             → update
//   DELETE /crm/v3/objects/:type/:id             → archive
//   POST   /crm/v3/objects/:type/search          → CRM Search
//   POST   /crm/v3/objects/:type/batch/{create,read,update,archive}
//   PUT    /crm/v4/objects/:ft/:fid/associations/:tt/:tid
//   GET    /crm/v4/objects/:ft/:fid/associations/:tt
//   DELETE /crm/v4/objects/:ft/:fid/associations/:tt/:tid
//
