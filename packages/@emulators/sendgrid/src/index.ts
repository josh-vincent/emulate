...
// Standalone direct-to-source sendgrid emulator. Mount it and clients hit
// sendgrid's real native paths (/v3/marketing/contacts) behind a bearer token — no Nango envelope. The Nango
// emulator remains the alternative; this is the "go direct" option.

const built = makeNativePlugin(spec);

export const sendgridPlugin = built.plugin;
