...
import { discordPlugin, seedFromConfig, storeToSeedConfig } from "../index.js";
...
function mk() {
  ...
  const app = new Hono();
  discordPlugin.register(app as never, store, new WebhookDispatcher(), base);
  return { app, store };
}
...
describe("discord standalone native (native-kit, seed-derived)", () => {
